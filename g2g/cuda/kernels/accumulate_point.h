...
__global__ void gpu_accumulate_point_open(
    ...
    G2G::vec_type<scalar_type,WIDTH>*  dxyz_a, G2G::vec_type<scalar_type,WIDTH>* dd1_a, 
    G2G::vec_type<scalar_type,WIDTH>* dd2_a, scalar_type* partial_density_b, 
    G2G::vec_type<scalar_type,WIDTH>* dxyz_b, G2G::vec_type<scalar_type,WIDTH>* dd1_b, 
    G2G::vec_type<scalar_type,WIDTH>* dd2_b) {
...
__global__ void gpu_accumulate_point(
    ...
    scalar_type* partial_density, G2G::vec_type<scalar_type,WIDTH>* dxyz,
